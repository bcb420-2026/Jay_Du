...
cigarette smoke conditions in humans, @werder2023adgrg6 started an investigation
...
Filtering these lowly-expressed genes is a critical prerequisite for 
...
contrast <- makeContrasts(
  ...
  "ADGRG6_kd_Smoke_vs_WT_Smoke" = groupADGRG6_kd_Smoke - groupWT_Smoke,
  levels = design
)
...
qlf_kd_smoke_vs_wt_smoke <- glmQLFTest(fit, contrast = contrast[, "ADGRG6_kd_Smoke_vs_WT_Smoke"])
...
tab_kd_smoke_vs_wt_smoke <- topTags(qlf_kd_smoke_vs_wt_smoke, n = Inf)$table %>% rownames_to_column("hgnc_symbol")
...
- I did not remove any individual samples as technical outliers, as the MDS 
  ...
  features that were considered lowly-expressed genes or noise. This 
