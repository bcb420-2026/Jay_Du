...
iAT2s—lab-grown versions derived from pluripotent stem cells(PSC).
...
The researchers employed a **2x2 factorial design** to test the interaction between genetic 
knockdown and environmental stress:
...
For me, this project is about more than just data; it is about understanding the
molecular breakdown behind the chronic symptoms I see in my own home and 
exploring the science that might one day offer better interventions for 
