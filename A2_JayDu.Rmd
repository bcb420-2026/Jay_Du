...
To simplify the representation and focus on the most robust biological signals, the network was then collapsed into a summary network. A stringent filtering threshold of $FDR < 0.005$ was applied to the enrichment results prior to visualization; this step was necessary to reduce node density and prevent the visual "mess" associated with overlapping, redundant gene sets, ensuring that only the most statistically significant thematic hubs remained.

```{r, fig.cap="Collapsed Summary Network of Enriched Pathways. The network illustrates major biological modules filtered at $FDR < 0.005$ to prioritize high-confidence functional themes. Nodes are colored based on the sign of the Normalized Enrichment Score (NES), with orange representing positive enrichment (upregulation) and blue representing negative enrichment (downregulation). Edges connect related pathways, highlighting the coordinated regulation of cell cycle, DNA maintenance, and metabolic machinery"}

knitr::include_graphics("data/A2_summary_network.png")
```
...
One of the most prominent themes in the enrichment map is cell cycle regulation and mitotic progression (at center low region on summary network). This is visualized through a dense, interconnected hub of pathways including the spindle cycle, chromosome alignment and condensation, and sister chromatid cohesion. The presence of "antigen degradation APC" suggests the involvement of the Anaphase-Promoting Complex, which is critical for the timed degradation of regulatory proteins during mitosis. This theme is highly consistent with our model, reflecting the experimental findings that ADGRG6 knockdown increases proliferation and shifts cells into the S and G2/M phases [@werder2023adgrg6].

Closely associated with the cell cycle hub is a second major theme of DNA replication, repair, and genomic maintenance. Clusters labeled with recombinational repair, DNA-templated replication, and telomere lengthening indicate a coordinated effort to maintain genome stability. Because one major discovery from this paper involves increased proliferation, these pathways likely represent the necessary cellular infrastructure required to manage the high metabolic cost of rapid DNA synthesis and to prevent the accumulation of damage during frequent divisions.

A third theme centers on chromatin organization and epigenetic regulation. The network reveals clusters involving nucleosome deposition, chromatin remodeling, and CENP-A nucleosome assembly. These processes are essential for the physical reorganization of the genome, ensuring that DNA is properly packaged for segregation and accessible for the transcription of pro-proliferative genes. This structural theme acts as a bridge, providing the physical framework for the genetic and mitotic activities observed in the first two themes.

Finally, the analysis reveals a significant theme involving metabolic bioenergetics and protein translation. The separate "island" on the right of the map highlights mitochondrial biogenesis, the respiratory chain (NADH), and purine processing, while the top-left clusters focus on protein translation synthesis and tRNA aminoacylation. Interestingly, a novel or distinct signature in this data is the negative enrichment (blue nodes) of plasma adhesion molecules and integrin surface matrix. This matches the paper'd conclusion that as the cells commit to the metabolic and replicative demands of the ADGRG6 knockdown phenotype, they undergo a structural shift, potentially weakening cell-cell junctions and adhesion to prioritize division over niche stability [@werder2023adgrg6].
