...
To avoid retesting and save computational resource, result table was saved at "data/tbl_wt_vs_kd_air.rds". Sample data is shown as follows:
...
write.table(ranked_list, 
            file = "my_ranked_genes.rnk", 
            sep = "\t",          # GSEA requires tab-separated values
            row.names = FALSE,   # Prevents R from adding row numbers
            col.names = FALSE,   # Removes column headers (recommended for GSEA)
            quote = FALSE)
```
